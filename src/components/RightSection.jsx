        ...
        <div className="absolute bottom-0 left-0 bg-vert-light-gradient !bg-transparent bg-gray-800 w-full">
          ...
          >
            <div className="relative flex h-full flex-1 flex-col">
              <div className="flex flex-col w-full flex-grow py-3 relative border border-gray-500 dark:border-gray-900/50 text-white rounded-md bg-[rgba(64,65,79, var(--tw-bg-opacity))]">
                <input
